...
package FlowPlugin::QAPerlBambooRESTClient;
use strict;
use warnings;
use LWP::UserAgent;
use JSON;
...
use FlowPDF::Log;
## DO NOT EDIT THIS BLOCK === rest client imports ends, checksum: 88707309b6a1516e5d641a00c25a364d ===
# Place for the custom user imports, e.g. use File::Spec
## DO NOT EDIT THIS BLOCK === rest client starts ===
=head1

FlowPlugin::QAPerlBambooRESTClient->new('http://endpoint', {
...
use constant {
    ...
    USER_AGENT => 'QAPerlBambooRESTClient REST Client',
...
Use this method to create a new FlowPlugin::QAPerlBambooRESTClient, e.g.

    my $client = FlowPlugin::QAPerlBambooRESTClient->new($endpoint,
...
# max-results: in query

# start-index: in query

sub getBuildsResults {
    my ($self, %params) = @_;

    $self->{method} = 'getBuildsResults';
    $self->{methodParameters} = \%params;

    my $uri = "/rest/api/latest/result/{{requestKey}}";
    ...
    if ($params{ 'start-index' }){
        $query->{'start-index'} = $params{ 'start-index' };
    }
...
## DO NOT EDIT THIS BLOCK === rest client ends, checksum: 82550efbd38672ec9ef62100f393c93b ===
=pod
