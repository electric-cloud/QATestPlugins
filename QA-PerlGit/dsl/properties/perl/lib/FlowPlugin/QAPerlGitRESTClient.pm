...
package FlowPlugin::QAPerlGitRESTClient;
use strict;
use warnings;
use LWP::UserAgent;
use JSON;
...
use FlowPDF::Log;
## DO NOT EDIT THIS BLOCK === rest client imports ends, checksum: e65e4094140c7e1a4d6eef927af5c454 ===
# Place for the custom user imports, e.g. use File::Spec
## DO NOT EDIT THIS BLOCK === rest client starts ===
=head1

FlowPlugin::QAPerlGitRESTClient->new('http://endpoint', {
...
use constant {
    ...
    USER_AGENT => 'QAPerlGitRESTClient REST Client',
...
Use this method to create a new FlowPlugin::QAPerlGitRESTClient, e.g.

    my $client = FlowPlugin::QAPerlGitRESTClient->new($endpoint,
...
## DO NOT EDIT THIS BLOCK === rest client ends, checksum: a8c0a0271c158ba0e61d90037a3eae6f ===
=pod
