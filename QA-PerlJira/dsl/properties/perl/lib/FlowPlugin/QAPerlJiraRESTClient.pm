...
package FlowPlugin::QAPerlJiraRESTClient;
use strict;
use warnings;
use LWP::UserAgent;
use JSON;
...
use FlowPDF::Log;
## DO NOT EDIT THIS BLOCK === rest client imports ends, checksum: a319f0721ac6bf53ecc4f03da037670d ===
# Place for the custom user imports, e.g. use File::Spec
## DO NOT EDIT THIS BLOCK === rest client starts ===
=head1

FlowPlugin::QAPerlJiraRESTClient->new('http://endpoint', {
...
use constant {
    ...
    USER_AGENT => 'QAPerlJiraRESTClient REST Client',
...
Use this method to create a new FlowPlugin::QAPerlJiraRESTClient, e.g.

    my $client = FlowPlugin::QAPerlJiraRESTClient->new($endpoint,
...
## DO NOT EDIT THIS BLOCK === rest client ends, checksum: c80687e1b80f44e8b839db961eb42273 ===
=pod
