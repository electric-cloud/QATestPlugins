...
package FlowPlugin::QAGitRESTClient;
use strict;
use warnings;
use LWP::UserAgent;
use JSON;
...
use FlowPDF::Log;
## === rest client imports ends, checksum: 3f0395f56771540bb40b8990327442f5 ===
# Place for the custom user imports, e.g. use File::Spec
## === rest client starts ===
=head1

FlowPlugin::QAGitRESTClient->new('http://endpoint', {
...
use constant {
    ...
    USER_AGENT => 'QAGitRESTClient REST Client',
...
Use this method to create a new FlowPlugin::QAGitRESTClient, e.g.

    my $client = FlowPlugin::QAGitRESTClient->new($endpoint,
...
sub getGitUserInfo {
    ...
    my $override = $self->can("getGitUserInfoOverride");
    if ($override) {
...
## === rest client ends, checksum: 6f40dbbe56d6e159a9485fdd737590a7 ===
=pod
